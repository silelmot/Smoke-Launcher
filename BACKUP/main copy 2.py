    ...
    def __init__(self, *args, **kwargs):
        ...
        for game in game_list:
            ...
            if is_game_installed(game_id):
                ...
                unpack_button = customtkinter.CTkButton(frame, text="📦", command=lambda gid=game_id: self.unpack_game(gid))
        ...
        # # Download Button
        # self.download_button = customtkinter.CTkButton(frame, text="Download Game", command=lambda: self.start_download(gid="1"))
        # self.download_button.grid(row=3, column=2, padx=10, pady=5, sticky="ew")
        ...
        # # Configure row 3 to expand and keep everything at the bottom
        # frame.grid_rowconfigure(0, weight=1)

        # # Configure columns to make sure everything is evenly spaced
