...
class Main(customtkinter.CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.refresh_button.pack(padx=10, pady=10, anchor="ne")
    ...
    def refresh_ui(self):
        ...
        for game in game_list:
            ...
            if is_game_installed(game_id): # Check if the game is installed (downloaded and unpacked)
                ...
                add_to_library_button.grid(row=row_num, column=1, padx=10, pady=5, sticky="ew")
                ...
                exe_selection_dropdown.grid(row=row_num, column=2, padx=10, pady=5, sticky="ew")
                ...
                unpack_button.grid(row=row_num, column=1, padx=10, pady=5, sticky="ew")
                ...
                delete_button.grid(row=row_num, column=2, padx=10, pady=5, sticky="ew")
            row_num += 1
